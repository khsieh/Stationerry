"""
Django settings for StationerryWeb project.
...
SECRET_KEY = 'g@g=1fm-nllf^+j)8x3y(k_b041b7)5izyhwww3!6(j7v3-nm@'
...
ROOT_URLCONF = 'StationerryWeb.urls'
...
WSGI_APPLICATION = 'StationerryWeb.wsgi.application'
